...
<body>
    ...
    <a href="dashboard.php">Beranda</a>
        ...
        <a href="pilihK.php">Pilih Kategori</a>
    ...
    <div class="content">
        <div class="container">
            <h2 class="colortxt">Selamat datang di Dashboard!</h2>
            <p class="colortxt">Ini adalah halaman dashboard Anda. Anda dapat mengakses berbagai layanan bimbingan konseling di sini.</p>

            <!-- Card Section -->
            <div class="row">
                <div class="col-md-4">
                    <div class="card-custom">
                        <h5>Layanan Terbaru</h5>
                        <p>Temukan layanan bimbingan terbaru yang tersedia untuk Anda.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card-custom">
                        <h5>Jadwal Konseling</h5>
                        <p>Periksa jadwal konseling Anda di sini.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card-custom">
                        <h5>Riwayat Bimbingan</h5>
                        <p>Lihat riwayat bimbingan konseling yang telah Anda lakukan.</p>
                    </div>
                </div>
            </div>
        </div>
